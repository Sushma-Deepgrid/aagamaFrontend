                                        ...
                                        if (values.email != '' && values.password != '') {
                                            axios.post(`https://aagama2.adgrid.in/auth/customer-login`, {
                                              ...
                                              .then((response) => {
                                                ...
                                                localStorage.setItem("userNumber",response.data.mobile)
                                                   localStorage.setItem("loggedIn",true)
                                                   localStorage.setItem('SelectedSubmenu', 'Dashboard');
                                                   if(response.data.token != '' && response.data.token != undefined){
                                                     ...
                                                     else if(response.data.user_type_id === 1 || response.data.user_type_id === 2){
