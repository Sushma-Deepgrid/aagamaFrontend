      ...
      cell: (index) => (
        ...
        <UncontrolledDropdown style={{marginTop:'-15%'}}>
                          ...
                          <DropdownMenu className="dropdown-menu-end">
                            ...
                            router.push('/admin/portalAdministration/UserList/EditUser');
  ...
  const tdStyle={
    ...
    return (
        ...
        <div className='d-flex justify-content-between align-items-center'>
            ...
            <Breadcrumb title='Portal Administration' titleText=' ' />
            <Link  href="/admin/portalAdministration/UserList/AddUser" className='buttonUi'  >
                Add User
              </Link>
        </div>
